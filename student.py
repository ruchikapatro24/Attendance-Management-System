...
class Student:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"C:\Users\ruchi\OneDrive\Desktop\Face Recognition System\images\overview-banner.webp")
        ...
        #second image
        # img1=Image.open(r"C:\Users\ruchi\OneDrive\Desktop\Face Recognition System\images\studpg2.jpeg")
        ...
        title_lbl=Label(bg_img,text="STUDENT ATTENDANCE",font=("times new roman",35,"bold"),bg="white",fg="darkgreen")
        title_lbl.place(x=0,y=0,width=1537,height=45)

        main_frame=Frame(bg_img,bd=2,bg="white")
        main_frame.place(x=20,y=76,width=1480,height=600)

        #left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=720,height=580)

        img_left=Image.open(r"C:\Users\ruchi\OneDrive\Desktop\Face Recognition System\images\images (2).jpeg")
        ...
        current_course_frame.place(x=15,y=150,width=710,height=120)
        ...
        dep_combo["values"] = ("Select Department", "CSE", "IT", "Civil", "Mechanical", "ECE", "ECSE-AI", "CSE-AI", "AIML")
        dep_combo.current(0)
        ...
        course_combo["values"] = ("Select Course", "CD", "WN", "FM", "CC","HCI","MP")
        ...
        class_student_frame.place(x=15,y=280,width=710,height=300)
        ...
        #class division
        class_div_label=Label(class_student_frame,text="Class Division:",font=("times new romn",13,"bold"),bg="white")
        ...
        self.var_radio=StringVar()  # Single variable to track selection
        ...
        btn_frame.place(x=0,y=200,width=707,height=35)
        ...
        btn_frame1.place(x=0,y=235,width=707,height=35)
        ...
        img_right=Image.open(r"C:\Users\ruchi\OneDrive\Desktop\Face Recognition System\images\studpg2.png")
        ...
        search_frame.place(x=5,y=120,width=707,height=70)
        ...
        table_frame.place(x=5,y=200,width=707,height=350)
    ...
    def update_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                Update=messagebox.askyesno("Update","Do you want to update this student's deatails",parent=self.root)
                if Update>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="Ruch@2412",database="attendance_management")
                    my_cursor=conn.cursor()
