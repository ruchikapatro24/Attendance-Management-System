...
class Attendance:
    def __init__(self,root):
        ...
        bg_img.place(x=0,y=200,width=1537,height=768)

        title_lbl=Label(bg_img,text="ATTENDANCE",font=("times new roman",35,"bold"),bg="white",fg="darkgreen")
        title_lbl.place(x=0,y=0,width=1537,height=45)

        main_frame=Frame(bg_img,bd=2,bg="white")
        main_frame.place(x=20,y=76,width=1480,height=550)

        #left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Attendance Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=720,height=530)

        img_left=Image.open(r"C:\Users\ruchi\OneDrive\Desktop\Face Recognition System\images\studpg2.jpeg")
        ...
        left_inside_frame.place(x=0,y=135,width=700,height=370)

        #labels and entry
        #attendance id
        studentId_label = Label(left_inside_frame, text="AttendanceID:", font=("times new roman", 13, "bold"), bg="white")
        ...
        btn_frame.place(x=0,y=330,width=707,height=35)
        ...
        Right_frame.place(x=740,y=10,width=720,height=530)

        table_frame=Frame(Right_frame,bd=2,relief=RIDGE,bg="white")
        table_frame.place(x=5,y=5,width=705,height=500)
    ...
    def exportCsv(self):
        try:
            ...
            with open(fln,mode="w",newline="") as myfile:
                ...
                messagebox.showeinfo("Data Export","Your Data exported to"+os.path.basename(fln)+"successfully")
    ...
    def update_data(self):
        ...
        # Also update in mydata (the CSV data list)
        for idx, row in enumerate(mydata):
            if row[0] == values[0]:  # Match using Attendance ID
